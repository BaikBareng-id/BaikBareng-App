...
const features: Feature[] = [
  ...
  {
    id: "8",
    title: "Connect IDRX Wallet",
    description: "Dapatkan bantuan cara connect IDRX Wallet",
    category: "Komunikasi",
    status: "available",
    icon: Bell,
    color: "bg-yellow-500",
  ...
  },
  {
    id: "9",
    title: "Legal",
    description: "Akses semua penjelasan tentang legal disini",
    category: "Keamanan",
    status: "available",
    icon: Smartphone,
    color: "bg-teal-500",
  ...
  {
    id: "10",
    title: "Mau Jadi Partner",
    description: "Isi data kalian disini dan Admin akan memeriksanya",
    category: "Partner",
    status: "available",
    icon: Globe,
    color: "bg-cyan-500",
